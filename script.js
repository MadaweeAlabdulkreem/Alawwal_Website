...
const Qs = [
  {
    ...
    opts:['تجربة حلول متعددة بشكل سريع','تحليل المشكلة بشكل منهجي خطوة بخطوة','ابتكار حلول جديدة وغير تقليدية','طلب المساعدة من فريق،أشخاص آخرين '],
  },
  {
    text:' ما أكثر ما يجذب اهتمامك؟ ',
    opts:['فهم كيفية عمل الأنظمة والتقنيات',' الإبداع والتصميم وتوليد الأفكار ','مساعدة الآخرين والتفاعل المباشر معهم',' التنظيم وإدارة المشاريع والمهام'],
  },
  {
